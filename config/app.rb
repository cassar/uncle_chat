...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'chat-app.com'
  config.app_name = 'Chat_app'
  config.mailer.from = 'Chat_app <no-reply@chat-app.com>'
  ...
  #
  config.app_secret = 'ZtSTLEKwf23R5Y4SS4O2K3iBoP6D-o0wkt7r44i4k2Nbs8CtpN9bajYXCEXzbWRRJg4'
